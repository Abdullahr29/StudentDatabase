package Database;
public class JTester extends javax.swing.JFrame {
    public JTester() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        c1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Subject", "Mathematics", "Physics", "Computer Science" }));
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(JTester.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
